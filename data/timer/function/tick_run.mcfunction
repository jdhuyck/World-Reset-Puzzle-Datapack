...
# 30s
execute if score "timer_value" countdownTimer matches 600 run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 1
execute if score "timer_value" countdownTimer matches 600 run bossbar set timer:countdown color yellow

# 10s
execute if score "timer_value" countdownTimer matches 200 run playsound minecraft:entity.arrow.hit_player master @s ~ ~ ~ 1 1
...
execute if score "timer_value" countdownTimer matches 80 run bossbar set timer:countdown color white
execute if score "timer_value" countdownTimer matches 80 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 1 1
execute if score "timer_value" countdownTimer matches 60 run bossbar set timer:countdown color red
execute if score "timer_value" countdownTimer matches 60 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 1 1
execute if score "timer_value" countdownTimer matches 40 run bossbar set timer:countdown color white
execute if score "timer_value" countdownTimer matches 40 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 1 1
execute if score "timer_value" countdownTimer matches 20 run bossbar set timer:countdown color red
